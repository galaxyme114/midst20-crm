...
class Shippers extends Component {
    ...
    save = () => {
        ...
        if (isNewItem) {
            ...
            axiosInstance.post(`shippers/`, postData)
            .then(res => {
            ...
            axiosInstance.patch(`shippers/` + dataItem.id +'/', postData)
            .then(res => {
    ...
    remove = () => {
        axiosInstance.delete(`shippers/` + this.state.delItem.id +'/')
        .then(res => {
            console.log(res)
            if (res.status === 204){
                this.setState({
            ...
            <div>
                <Card>
                    <CardTitle className="bg-light border-bottom p-3 mb-0 font-24">
                        <i className="fas fa-people-carry mr-2"> </i>
                        Shippers Management
                    </CardTitle>
                    <CardBody className="">
                        <div className="">
